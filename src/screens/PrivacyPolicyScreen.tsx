  ...
  return (
    <GlassBackground>
      <ScrollView style={{ flex: 1 }} contentContainerStyle={styles.content}>
        ...
        <Text style={[styles.lastUpdated, { color: colors.textMuted }]}>Última atualização: Abril 2026</Text>
...
• Nenhum rastreamento de sua atividade"
        ...
        <View style={[styles.footer, { backgroundColor: colors.surface, borderLeftColor: colors.primary }]}>
...
function Section({ title, content, colors }: SectionProps) {
  return (
